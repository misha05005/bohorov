...
for (let key in cars) {
    let div.child = document.createElement(tagName:'div');
    div.child.className = 'cars-list_item'; 
    div.child.innerHTML = '' + 
        <div class = 'cars-list_item-area'> +
            <div class = 'cars-list_item-img'>+
                <img src="' + cars[key].img + cars[key].car + " >
            </div> +
            <div class="cars-list_item-content"> +
                '<h2>' + cars[key].car + '' + cars[key].madel +'</h2>'+
